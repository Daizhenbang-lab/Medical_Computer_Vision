...
parser.add_argument('--slide_path', type=str, default='images_Series1',
                    help='path to slide image or directory')
parser.add_argument('--save_sample_path', type=str, default='full_sample',
                    help='directory to save the sample segmentation')
parser.add_argument('--save_mask_path', type=str, default='full_mask',
